...
export default function Footer() {
  return (
    <footer className="border-t hairline bg-[#1A1A1A] text-white mt-20">
      <div className="max-w-[1480px] mx-auto px-4 md:px-8 py-12 grid grid-cols-2 md:grid-cols-5 gap-10">
        ...
        <FooterCol title="Help" items={["Payments", "Shipping", "Cancellation & Returns", "FAQ"]} />
